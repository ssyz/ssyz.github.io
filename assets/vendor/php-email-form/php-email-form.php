...
class PHP_Email_Form {
  ...
  public function add_message($content, $label = '', $length_check = false) {
    $message = filter_var($content, FILTER_UNSAFE_RAW) . '<br>';
    if( $length_check ) {
  ...
  public function send() {
    ...
    $from_name = filter_var( $this->from_name, FILTER_UNSAFE_RAW);
    $from_email = filter_var( $this->from_email, FILTER_VALIDATE_EMAIL);
    $subject = filter_var( $this->subject, FILTER_UNSAFE_RAW, FILTER_FLAG_NO_ENCODE_QUOTES);
